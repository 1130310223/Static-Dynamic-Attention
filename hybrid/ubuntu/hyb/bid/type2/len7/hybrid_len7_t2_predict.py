...
def init_command_line(argv):
	...
	description.add_argument("--max_context_size", type=int, default=7)
...
if __name__ == '__main__':
	...
	if not os.path.exists('./result/'):
		os.mkdir('./result/')
	pred_res_file = open("./result/ubu_pred_res_hyb_len7_t2",'w')
	pred_ans_file = open("./result/ubu_pred_ans_hyb_len7_t2",'w')
