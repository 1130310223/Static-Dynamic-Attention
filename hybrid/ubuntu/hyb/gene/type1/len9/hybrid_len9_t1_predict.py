...
#sys.path.append('../')
from hybrid_t1_model import Seq2Seq
...
def init_command_line(argv):
	...
	description.add_argument("--w2v_path", type=str, default="/users3/yfwang/rg_data/w2v/ubuntu/")
	description.add_argument("--corpus_path", type=str, default="/users3/yfwang/rg_data/corpus/ubuntu/")
	description.add_argument("--w2v", type=str, default="ubuntu_train_all_200e.w2v")
	description.add_argument("--test_file", type=str, default="ubuntu_test_sessions.txt")
...
if __name__ == '__main__':
	...
	if not os.path.exists('./result/'):
		os.mkdir('./result/')
	pred_res_file = open("./result/ubu_pred_res_hyb_t1_h1",'w')
	pred_ans_file = open("./result/ubu_pred_ans_hyb_t1_h1",'w')
