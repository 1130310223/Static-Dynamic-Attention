...
if __name__ == '__main__':
	...
	test_file_path = "/users3/yfwang/rg_data/corpus/ubuntu/ubuntu_test_sessions.txt"
	...
	print ("writing...")
	pred_res_file = open("./result/ubu_pred_res_hybrid_h1",'w')
	pred_ans_file = open("./result/ubu_pred_ans_hybrid_h1",'w')
